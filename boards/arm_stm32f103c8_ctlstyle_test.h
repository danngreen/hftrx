...
*/
	...
	//#define WITHPREAMPATT2_10DB		1	// Управление УВЧ и двухкаскадным аттенюатором с затуханиями 0 - 10 - 20 - 30 dB */
	...
	//#define KEYB_VERTICAL_REV_SIMPLEFREQ	1	/* расположение кнопок для плат "Воробей" и "Колибри" - только прямой ввод частоты */
	...
	//#define WITHPOTIFSHIFT	1		// потенциометр управления сдвигом полосы ПЧ

	//#define WITHPBT		1	/* используется PBT (если LO3 есть) */
	//#define WITHPOTPBT		1		// потенциометр управления сужением полосы ПЧ
